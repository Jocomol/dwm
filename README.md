...
- [Clickable statusbar](https://dwm.suckless.org/patches/statuscmd/) with my build of [dwmblocks](https://github.com/jocomol/dwmblocks).
...
```bash
git clone https://github.com/Jocomol/dwm.git
cd dwm
sudo make install
```
